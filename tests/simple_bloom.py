...
w = WiSARD(discriminators=[Discriminator([CountMinSketchRAM(), CountMinSketchRAM()]), Discriminator([CountMinSketchRAM(), CountMinSketchRAM()])], indices=list(range(4)), tuple_size=2, shuffle_indices=True)
w.bleach = 1
